...
$hasil=mysqli_query($connection,$sql) or die(mysqli_error($connection));
...
<div class="utama">
	...
	<span class="float-right">
		<form action="" method="post" class="form-inline">
			<button class="btn btn-success" type="submit" id="tombol-cari">Cari</button>
			<input class="form-control mr-2 ml-2" type="text" name="cari" id ="keyword" placeholder="cari data mahasiswa..."  autofocus autocomplete="off"> Nama terdekat
		</form>
	</span>
	<br><br>
	<ul class="pagination">
